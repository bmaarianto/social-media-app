      ...
      <div className="max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500w">@{user.username}</p>
          </div>
        </div>
        {/* Text Area */}
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-300">
          ...
          <button disabled={loading} onClick={() => toast.promise(handleSubmit(), {
            ...
            className="text-sm bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-500 hover:to-purple-700 
